          ...
          <div className={styles['container']} id={styles['detail-page']}>
            <div className={styles['film-infor']}>
              <div className={styles['image']}>
                <img className={styles['avatar']} itemProp="image" alt="" /> <a href="" className="icon-play" />
                ...
                <div className={styles['content']}>
                  ...
                  <div id="film-content">
                    <p><b>Công Tố Viên Chuyển Sinh - </b>Again My Life 2022 xuất phát điểm không suôn sẻ khi là một học sinh trung học cấp ba để học lên đại học và cuối cùng đã vượt qua kỳ thi
                      ...
                      thấy rằng mình <span id="dots">...</span><span id={styles['more']}>phải quay trở lại trường đại học và hoàn thành cuộc hành trình học tập của mình một lần nữa - trong khi anh ta cố gắng khám phá sự thật về những gì đã xảy ra với mình. Trên hành trình của mình, anh gặp Kim
